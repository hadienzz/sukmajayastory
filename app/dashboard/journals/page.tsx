...
export default function DashboardJournalsList() {
  ...
  const { data: journals, isLoading, isError, error } = useJournalsQuery();
    ...
    <div>
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between mb-8">
        <div>
          ...
          <p className="body-text text-sm mt-1">Manage your journal entries</p>
        </div>
        <Link
              ...
              <table className="w-full min-w-190">
                <thead>
                  <tr className="border-b border-[#eee]">
                    ...
                    <th className="text-left px-4 sm:px-6 py-3 hidden md:table-cell">
                      <span className="category-label">Category</span>
                    </th>
                    <th className="text-left px-4 sm:px-6 py-3 hidden lg:table-cell">
                      ...
                      <td className="px-4 sm:px-6 py-4">
                        <div className="flex items-center gap-3">
                          ...
                          <div className="min-w-0">
                            <p className="font-light text-sm truncate max-w-56 sm:max-w-72 md:max-w-96">
                              {journal.title}
                            </p>
                            <p className="text-[11px] text-[#aaa] truncate max-w-24 sm:max-w-32 md:max-w-40">
                              {journal.excerpt}
                            </p>
                          </div>
                        </div>
                      ...
                      <td className="px-4 sm:px-6 py-4">
                        <div className="flex items-center justify-end gap-2">
                          ...
                          <DeleteJournalDialog
                            ...
                            onConfirmDelete={() =>
                              deleteMutation.mutateAsync({ id: journal.id })
                            }
                            trigger={
                              <button
